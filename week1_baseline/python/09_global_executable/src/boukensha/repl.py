...
class Repl:
    ...
    def _banner(self) -> str:
        # Simplified this step (no API-key/config-dir validation) — see the
        # 09_global_executable plan's "known regressions" note: this drops
        # the validation 08_the_repl_loop had, matching Ruby's own history,
        # flagged there as a real usability regression rather than silently
        # fixed here.
